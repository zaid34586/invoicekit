      ...
      {open && (
        <div className="absolute right-0 mt-2 w-56 card p-1.5 animate-scale-in z-50">
          ...
          <button
            ...
            className="w-full text-left px-3 py-2 rounded-md text-sm text-slate-600 hover:bg-slate-100 transition flex items-center gap-2"
          >
          ...
          <button
            ...
            className="w-full text-left px-3 py-2 rounded-md text-sm text-red-600 hover:bg-red-50 transition flex items-center gap-2"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
