...
function SidebarContent({ onNavigate }: { onNavigate?: () => void }) {
  ...
  return (
    <nav className="flex flex-col gap-1.5 px-4 py-6">
      ...
      {(role === "owner" || role === "manager") && <NavItem to="/dashboard" icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg>} label="Dashboard" onClick={onNavigate} />}
      {(role === "owner" || role === "manager" || role === "staff") && <NavItem to="/new" icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" /></svg>} label="New Invoice" onClick={onNavigate} />}
