...
function SidebarContent({ onNavigate }: { onNavigate?: () => void }) {
  return (
    <nav className="flex flex-col gap-1 px-3 py-4">
      ...
      <NavItem to="/support" icon={<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M18 10c0 3.314-2.686 6-6 6a6.61 6.61 0 01-2.13-.35L6 17l1.35-3.87A5.97 5.97 0 016 10c0-3.314 2.686-6 6-6s6 2.686 6 6z" /><path strokeLinecap="round" strokeLinejoin="round" d="M9 9h.01M12 9h.01M15 9h.01" /></svg>} label="Support" onClick={onNavigate} />
        ...
        <div className="flex items-center justify-between h-16 px-4 sm:px-6">
          <div className="flex items-center gap-3">
            ...
            <NavLink to="/dashboard" className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-slate-900">InvoiceKit</span>
            </NavLink>
          </div>
          <UserMenu />
        </div>
