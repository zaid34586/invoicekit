...
export default function Security() {
  return (
    <PublicPageLayout eyebrow="Trust" title="Security at Rivox" description="Security is part of how Rivox is designed, operated, and improved.">
      ...
      <section><h2 className="text-xl font-black text-slate-950">Report a security concern</h2><p className="mt-3">Send a clear description to <a className="font-bold text-primary-600 hover:underline" href="mailto:support@rivox.com">support@rivox.com</a>. Do not publicly disclose sensitive details before we have had a reasonable opportunity to investigate.</p></section>
    </PublicPageLayout>
  );
}
